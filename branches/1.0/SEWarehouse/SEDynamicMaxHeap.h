#ifndef Swing_DynamicMaxHeap_H
#define Swing_DynamicMaxHeap_H
...
public:
    ...
    DynamicMaxHeap(DynamicArray<Type>& rDA, int iUsed, 
...
public:
    ...
    DynamicMaxHeap<Type>& operator = (const DynamicMaxHeap<Type>& rOther);
