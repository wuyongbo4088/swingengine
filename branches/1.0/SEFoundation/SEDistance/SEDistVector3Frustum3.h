...
#ifndef Swing_DistVector3Frustum3_H
#define Swing_DistVector3Frustum3_H
...
// Date:20090115
//----------------------------------------------------------------------------
class SE_FOUNDATION_API SEDistVector3Frustum3f 
    : public SEDistance<float, SEVector3f>
{
public:
    SEDistVector3Frustum3f(const SEVector3f& rVector, const SEFrustum3f& 
        rFrustum);
