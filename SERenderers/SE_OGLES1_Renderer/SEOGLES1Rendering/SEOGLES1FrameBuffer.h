...
#ifndef Swing_OGLES1FrameBuffer_H
#define Swing_OGLES1FrameBuffer_H
...
//----------------------------------------------------------------------------
// 名称:OpenGL ES1 Framebuffer基类
// 说明:
// 作者:Sun Che
// 时间:20090607
//----------------------------------------------------------------------------
class SE_RENDERER_API OGLES1FrameBuffer : public FrameBuffer
{
    SE_DECLARE_INITIALIZE;

public:
    OGLES1FrameBuffer(FormatType eFormat, DepthType eDepth,
    ...
    virtual ~OGLES1FrameBuffer(void);
