...
GLenum OGLES2Renderer::ms_aeAlphaSrcBlend[AlphaState::SBF_COUNT] =
{
    GL_ZERO,
    GL_ONE,
    GL_DST_COLOR,
...
GLenum OGLES2Renderer::ms_aeAlphaDstBlend[AlphaState::DBF_COUNT] =
{
    GL_ZERO,
    GL_ONE,
    GL_SRC_COLOR,
...
//----------------------------------------------------------------------------
void OGLES2Renderer::SetAlphaState(AlphaState* pState)
{
