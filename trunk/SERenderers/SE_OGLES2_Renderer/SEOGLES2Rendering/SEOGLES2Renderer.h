...
//----------------------------------------------------------------------------
// 名称:OpenGL ES2 Renderer虚基类
// 说明:
// 作者:Sun Che
// 时间:20090701
//----------------------------------------------------------------------------
class SE_RENDERER_API OGLES2Renderer : public Renderer
{
...
protected:
    OGLES2Renderer(FrameBuffer::FormatType eFormat,
    ...
    // 摄像机更新.
    friend class OGLES2FrameBuffer;
