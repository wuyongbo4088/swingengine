...
//----------------------------------------------------------------------------
// 名称:OpenGL ES2 Framebuffer基类
// 说明:
// 作者:Sun Che
// 时间:20090607
//----------------------------------------------------------------------------
class SE_RENDERER_API OGLES2FrameBuffer : public FrameBuffer
{
    SE_DECLARE_INITIALIZE;

public:
    OGLES2FrameBuffer(FormatType eFormat, DepthType eDepth,
    ...
    virtual ~OGLES2FrameBuffer(void);
