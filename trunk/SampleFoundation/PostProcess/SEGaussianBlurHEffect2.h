...
// 时间:20090715
//----------------------------------------------------------------------------
class GaussianBlurHEffect2 : public ShaderEffect
{
    SE_DECLARE_RTTI;
    SE_DECLARE_NAME_ID;
    SE_DECLARE_STREAM;
...
public:
    GaussianBlurHEffect2(const String& rBaseName);
...
typedef SmartPointer<GaussianBlurHEffect2> GaussianBlurHEffect2Ptr;
