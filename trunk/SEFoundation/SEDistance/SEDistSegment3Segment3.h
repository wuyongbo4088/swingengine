...
//----------------------------------------------------------------------------
// 名称:DistSegment3Segment3f类
// 说明:
// 作者:Sun Che
// 时间:20090119
//----------------------------------------------------------------------------
class SE_FOUNDATION_API DistSegment3Segment3f
    : public Distance<float, Vector3f>
{
public:
    DistSegment3Segment3f(const Segment3f& rSegment0,
        const Segment3f& rSegment1);

    // 对象访问.
    const Segment3f& GetSegment0(void) const;
    const Segment3f& GetSegment1(void) const;
...
private:
    const Segment3f* m_pSegment0;
    const Segment3f* m_pSegment1;
