...
//----------------------------------------------------------------------------
// Name:Managed texture tile effect class
// Description:
// Author:Sun Che
// Date:20100203
//----------------------------------------------------------------------------
public ref class ManagedTextureTileEffect sealed : INativeObject, 
...
internal:
    [CLSCompliant(false)]
    ManagedTextureTileEffect(TextureTileEffect* pEffect);
...
private:
    TextureTileEffectPtr* m_pspTextureTileEffect;
};
