...
//----------------------------------------------------------------------------
// 名称:DistLine3Segment3f类
// 说明:
// 作者:Sun Che
// 时间:20090113
//----------------------------------------------------------------------------
class SE_FOUNDATION_API DistLine3Segment3f : public Distance<float, Vector3f>
{
public:
    DistLine3Segment3f(const Line3f& rLine, const Segment3f& rSegment);
