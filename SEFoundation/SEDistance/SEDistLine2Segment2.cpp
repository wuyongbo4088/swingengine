...
//----------------------------------------------------------------------------
DistLine2Segment2f::DistLine2Segment2f(const SELine2f& rLine,
...
//----------------------------------------------------------------------------
const SELine2f& DistLine2Segment2f::GetLine() const
{
    return *m_pLine;
}
//----------------------------------------------------------------------------
const SESegment2f& DistLine2Segment2f::GetSegment() const
{
    return *m_pSegment;
}
//----------------------------------------------------------------------------
