...
#ifndef Swing_DistVector2Line2_H
#define Swing_DistVector2Line2_H
...
//----------------------------------------------------------------------------
// 名称:DistVector2Line2f类
// 说明:
// 作者:Sun Che
// 时间:20090114
//----------------------------------------------------------------------------
class SE_FOUNDATION_API DistVector2Line2f : public Distance<float, Vector2f>
{
public:
    DistVector2Line2f(const Vector2f& rVector, const Line2f& rLine);
