...
public:
    ...
    // SE_GetPath搜索目录列表,如果指定文件名存在,则返回其完整路径名称,否则返回null,
    // eMode以下是枚举值
    enum
    {
        SM_READ,
    ...
    static const char* SE_GetEnv(const char* pEnvVarName);  // 根据环境变量名称,返回其对应值
